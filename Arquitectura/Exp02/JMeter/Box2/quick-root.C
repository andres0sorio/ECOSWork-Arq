{
  ...
  in.open("concurrency-1000.csv"); //this file contains all of your data
  ...
  histos[0] = new TH1D("Exp1","Concurrency Experiment",100, 0.0, 100);
  histos[1] = new TH1D("Exp2","Concurrency Experiment",100, 0.0, 100);
  histos[2] = new TH1D("Exp3","Concurrency Experiment",100, 0.0, 100);
  histos[3] = new TH1D("Exp4","Concurrency Experiment",100, 0.0, 100);
  
  double timeStamp,elapsed,bytes,grpThreads,allThreads,Latency,IdleTime;
  ...
  while ( in.good() ) 
  {
    ...
    in >>  timeStamp >> elapsed >> bytes >> grpThreads >> allThreads >> Latency >> IdleTime;
